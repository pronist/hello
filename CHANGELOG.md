...
- 본문 맨 위에 목차를 위한 TOC(Table of Content)기능을 추가할 수 있습니다.
...
- 대댓글의 갯수가 표시됩니다.
- 슬라이드쇼(스크린)의 이름이 슬라이드쇼로 변경되었습니다.
- 그리드/갤러리 커버 사용시 한 줄로 표시되는 버그가 수정되었습니다. ([#60](https://github.com/tistory-projects/tistory-skin-hELLO/issues/60))
- 모든 표 테마 스타일은 일원화 되어 적용됩니다. ([#108](https://github.com/tistory-projects/tistory-skin-hELLO/issues/108))
- 공지사항 리스트는 제목을 표시하지 않습니다. ([#134](https://github.com/tistory-projects/tistory-skin-hELLO/issues/134))
- 글 모드가 제거됨에 따라 썸네일이 있는 경우 이전의 테이프 모드가 적용되며 썸네일이 없다면 기본 모드로 적용됩니다.

### 제거

- 이전 글/다음 글 표시가 제거되었습니다.
- 슬라이더 커버가 제거되었습니다.
- 슬라이드쇼(테이프) 커버가 제거되었습니다.
- 기본 커버 및 리스트 스타일이 제거되었습니다
- 갤러기 커버 및 리스트 스타일이 제거되었습니다.
- 글 모드가 제거되었습니다.
- 이미지 모드가 제거되었습니다.
- 인덱스 넓이를 설정할 수 있는 스킨옵션이 제거되었습니다.
- 상호 작용 메시지가 제거되었습니다.
